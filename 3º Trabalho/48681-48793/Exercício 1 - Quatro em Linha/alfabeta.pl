%Descomentar o resto da instrução para executar o jogo sem o agente inteligente
...
alfabeta(Ei,Opf) :- 
	findall(Vc-Op, (oper(Ei,Op,b,Es), alfabeta_min(Es,Vc,1,-10000,10000)), L),
	escolhe_max(L,Opf).
